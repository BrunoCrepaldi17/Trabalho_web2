...
--
-- Host: 127.0.0.1
-- Tempo de geração: 09-Abr-2023 às 01:27
...
(46, 'teste foto', '', 'M', 'foto@teste.com', '$2y$10$BF5lpXYPsi7lY6PUePTzQOCaMpfIziu0lFfRxltUM4H0wdhNCNgnG', 7);
...
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
